...
SOURCE_CATALOG = [
    {'key':'jobspy','name':'JobSpy — LinkedIn / Indeed / Google','source_type':'jobspy','mode':'experimental','description':'Experimental open-source scraper integration for LinkedIn, Indeed, Google Jobs and Glassdoor. Disabled until explicitly configured; may be affected by rate limits or anti-bot changes.'},
