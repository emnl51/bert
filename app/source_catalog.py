...
SOURCE_CATALOG = [
    ...
    {'key':'stepstone','name':'StepStone Germany — Experimental','source_type':'stepstone','mode':'experimental','description':'Experimental direct StepStone search provider. Uses public job-search result pages with conservative request limits, no CAPTCHA/proxy bypass, and fails safely on blocking or layout changes.'},
    ...
    {'key':'stepstone-search','name':'StepStone Germany — Manual search','source_type':'search_link','mode':'search-only','description':'Open the equivalent StepStone search in a new tab. Recommended as a fallback when the experimental provider is blocked or StepStone changes its page layout.','url_template':'https://www.stepstone.de/jobs/{query_slug}/in-{location_slug}'},
