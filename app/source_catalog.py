...
SOURCE_CATALOG = [
    {'key':'linkedin','name':'LinkedIn Jobs','source_type':'search_link','mode':'search-only','description':'Open a targeted LinkedIn Jobs search. No scraping is performed by JobTrack.','url_template':'https://www.linkedin.com/jobs/search/?keywords={query}&location={location}'},
    {'key':'indeed','name':'Indeed Germany','source_type':'search_link','mode':'search-only','description':'Open a targeted Indeed Germany search. No scraping is performed by JobTrack.','url_template':'https://de.indeed.com/jobs?q={query}&l={location}'},
    ...
    {'key':'glassdoor','name':'Glassdoor','source_type':'search_link','mode':'search-only','description':'Open a targeted Glassdoor search; no automated scraping.','url_template':'https://www.google.com/search?q=site%3Aglassdoor.de+{query}+{location}'},
