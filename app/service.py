    ...
    try:
        ...
        for raw_job in fetched:
            ...
            for profile in profiles:
                ...
                job.language_score, job.language_label, job.language_reasons = assess_language_fit(
        ...
        result = {
            ...
            "profiles": [
                {"id": p["id"], "name": p["name"], "matches": profile_match_counts[p["id"]]} for p in profiles
            ],
            "matches": [
                {
                    ...
                    "location": j.location,
                    "job_fit": j.score,
                    "language_fit": j.language_score,
                    "overall": j.overall_score,
                    "language_label": j.language_label,
                    "url": j.url,
                    "reasons": j.reasons,
                    "language_reasons": j.language_reasons,
                }
