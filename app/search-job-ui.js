(() => {
  ...
  function populateEditor(job, duplicate = false) {
    ...
    $('sjEmploymentMode').value = job?.employment_mode || 'prefer';
  ...
  function editorPayload() {
    ...
    return {
      ...
      employment_mode: $('sjEmploymentMode').value,
  ...
  function payloadFromJob(job, changes = {}) {
    return {
      ...
      min_language_score_override: job.min_language_score_override, employment_mode: job.employment_mode || 'prefer', max_results: job.max_results,
