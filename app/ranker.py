...
ENGLISH_SIGNALS = (
    'fluent english', 'business english', 'excellent english', 'very good english',
    'english required', 'english is required', 'working language is english',
    'english-speaking', 'english speaking', 'professional english', 'strong english',
    'good command of english', 'good knowledge of english', 'international team',
    'international environment', 'global team',
)
GERMAN_OPTIONAL = (
    'german is a plus', 'german would be a plus', 'german is an advantage',
    'german preferred', 'german nice to have', 'german is nice to have',
    'german not required', 'german is not required', 'no german required',
    'german beneficial', 'deutschkenntnisse von vorteil', 'deutsch von vorteil',
    'deutsch wünschenswert', 'deutsch wuenschenswert', 'deutschkenntnisse sind ein plus',
    'deutschkenntnisse sind von vorteil', 'german skills are a plus',
    'knowledge of german is a plus',
)
GERMAN_LEARNING = (
    'willingness to learn german', 'willing to learn german', 'learn german',
    'bereitschaft deutsch zu lernen', 'deutschkurs', 'german classes', 'german course',
    'language course',
)
BASIC_GERMAN = (
    'basic german', 'basic knowledge of german', 'german a2', 'a2 german', 'deutsch a2',
    'grundkenntnisse deutsch', 'grundkenntnisse in deutsch', 'german b1', 'b1 german',
    'deutsch b1', 'b1-niveau', 'b1 level', 'german level b1',
)
B2_PREFERRED = (
    'b2 preferred', 'b2 is a plus', 'b2 would be a plus', 'b2 nice to have',
    'deutsch b2 von vorteil', 'german b2 preferred', 'german b2 is a plus',
)
B2_SIGNALS = (
    'german b2', 'b2 german', 'deutsch b2', 'b2-niveau', 'b2 level', 'german level b2',
)
GERMAN_HEAVY = (
    'native german', 'german native', 'german mother tongue', 'mother tongue german',
    'german c1', 'c1 german', 'deutsch c1', 'c1-niveau', 'german c2', 'c2 german',
    'deutsch c2', 'business fluent german', 'business-fluent german', 'fluent german required',
    'german mandatory', 'german is mandatory', 'german is essential',
    'verhandlungssicheres deutsch', 'verhandlungssicher deutsch', 'deutsch zwingend erforderlich',
    'fließende deutschkenntnisse', 'fliessende deutschkenntnisse',
)
GENERIC_GERMAN_REQUIRED = (
    'german required', 'german is required', 'good german required', 'deutsch erforderlich',
    'gute deutschkenntnisse erforderlich', 'sehr gute deutschkenntnisse',
)
